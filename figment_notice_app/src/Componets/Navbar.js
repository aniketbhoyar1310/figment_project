...
const Navbar = () => {
  ...
  return (
    <Disclosure
      as="nav"
      className=" text-black shadow sticky top-0 z-50 backdrop-filter backdrop-blur-lg bg-opacity-30"
    >
      {({ open }) => (
        <>
                      ...
                      <NavLink
                        ...
                        className={classNames(
                          location.pathname === item.to
                            ? "border-b-2 border-[rgb(77,140,255)] text-[rgb(77,140,255)]"
                            : "text-gray-800  delay-200  hover:text-[",
