        ...
        <div className="container mx-auto px-10 py-7  ">
          <div className="relative w-full flex flex-col shadow-lg rounded-md">
            ...
            <div className="flex px-3 justify-between">
              <button
                type="button"
                className={`text-green-500 border focus:ring-3 focus:outline-none font-medium  text-sm   text-center  mb-2 me-1 rounded-md px-3 outline-offset-2 ${
              ...
              <div className=" justify-items: end">
                <button
                  type="button"
                  className={`text-green-500 border focus:ring-3 py-1.5 focus:outline-none font-medium  text-sm   text-center  mb-2 me-1 rounded-md px-3 outline-offset-2 ${
            ...
            <div className="overflow-x-auto px-3">
              <p className="my-2 ms-1 text-red-500">
